...
uploads/mypm:	file format mach-o arm64

Disassembly of section __TEXT,__text:

0000000100003f44 <_main>:
100003f44: d100c3ff    	sub	sp, sp, #0x30
100003f48: a9027bfd    	stp	x29, x30, [sp, #0x20]
100003f4c: 910083fd    	add	x29, sp, #0x20
100003f50: 52800008    	mov	w8, #0x0                ; =0
100003f54: b90013e8    	str	w8, [sp, #0x10]
100003f58: b81fc3bf    	stur	wzr, [x29, #-0x4]
100003f5c: b81f83bf    	stur	wzr, [x29, #-0x8]
100003f60: b81f43bf    	stur	wzr, [x29, #-0xc]
100003f64: b85f83a8    	ldur	w8, [x29, #-0x8]
100003f68: b85f43a9    	ldur	w9, [x29, #-0xc]
100003f6c: 6b09010a    	subs	w10, w8, w9
